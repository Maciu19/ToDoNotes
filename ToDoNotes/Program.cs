...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "ToDoNotes API", Version = "v1" });
...
builder.Services.AddDbContext<ToDoNotesDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("ToDoNotesConnectionString")));
